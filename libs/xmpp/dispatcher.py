...
class Dispatcher(PlugIn):
    ...
    def Process(self, timeout=0):
        ...
        if len(self._pendingExceptions) > 0:
            ...
            raise _pendingException[0].with_traceback(_pendingException[2]) if isinstance(_pendingException[0], BaseException) else _pendingException[1].with_traceback(_pendingException[2])
