...
class Session:
    ...
    def start_feature(self,f):
        ...
        if self.feature_in_process: raise RuntimeError("Starting feature %s over %s !"%(f,self.feature_in_process))
    ...
    def stop_feature(self,f):
        ...
        if self.feature_in_process!=f: raise RuntimeError("Stopping feature %s instead of %s !"%(f,self.feature_in_process))
        self.feature_in_process=None
