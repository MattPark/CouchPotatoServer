...
Page.Log = new Class({
    ...
    showReport: function(text) {
        var self = this, version = Updater.getInfo(), body = self.report_text.replace("{issue}", text).replace("{version}", version && version.version ? version.version.repr : "..."), textarea;
        var overlay = new Element("div.mask.report_popup", {
            ...
            events: {
                click: function(e) {
                    e.stop();
                    var body = textarea.get("value"), href = e.target.get("href");
