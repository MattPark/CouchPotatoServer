...
var UserscriptSettingTab = new Class({
    ...
    addSettings: function() {
        ...
        self.settings.addEvent("create", function() {
            ...
            }).inject(self.settings.tabs.automation.content, "top").adopt(new Element("div.bookmarklet_wrapper").adopt(new Element("span.bookmarklet").adopt(new Element("a.button.green", {
                text: "+CouchPotato",
...
Page.Wizard = new Class({
    ...
    headers: {
        ...
        automation: {
            ...
            description: "You can easily add movies from your favorite movie site, like IMDB, Rotten Tomatoes, Apple Trailers and more. Just drag the bookmarklet to your bookmarks." + "<br />Once installed, just click the bookmarklet on a movie page and watch the magic happen ;)",
            content: function() {
        ...
        finish: {
            title: "Finishing Up",
            description: "Are you done? Did you fill in everything as much as possible?" + "<br />Be sure to check the settings to see what more CP can do!",
