...
Option.Apprise_urls = new Class({
    ...
    _createRow: function(schema, url, enabled, on_snatch) {
        ...
        var snatch_wrapper = new Element("div.apprise-snatch-wrapper", {title: "Also notify when a movie is snatched"});
        var snatch_check = new Element("input", {type: "checkbox", checked: on_snatch !== false, events: {change: function() { self._saveAll(); }}});
    ...
    _saveAll: function() {
        ...
        self._rows.each(function(row) {
            ...
            entries.push({schema: schema, url: url_input ? url_input.get("value").trim() : "", enabled: toggle_input ? !!toggle_input.checked : true, on_snatch: snatch_input ? !!snatch_input.checked : true});
        });
