...
Page.Settings = new Class({
    ...
    createList: function(content_container) {
        ...
        var wrapper = new Element("div.add_service_wrapper", {"styles": {"padding": "10px 20px", "border-bottom": "1px solid #ebebeb"}}).inject(list_el, "top");
        var dropdown = new Element("select.add_service_dropdown", {"events": {"change": function() {
    ...
    afterInject: function() {
        ...
        if(self.parentList){
            new Element("a.icon-cancel.remove_provider", {
                ...
                "styles": {"float": "right", "cursor": "pointer", "font-size": "16px", "line-height": "30px", "opacity": "0.5"},
                "events": {
...
Option.Apprise_urls = new Class({
    ...
    _createRow: function(schema, url, enabled, on_snatch) {
        ...
        var builder_link = new Element("a.button.apprise-builder-link", {href: self._getBuilderUrl(schema), target: "_blank", title: "Open URL Builder", text: "Wizard", styles: {position: "static", overflow: "visible", "flex-shrink": "0"}});
