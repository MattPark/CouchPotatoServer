...
var AboutSettingTab = new Class({
    ...
    createAbout: function() {
        ...
        self.settings.createGroup({
            ...
            name: "variables"
        }).inject(self.content).adopt((about_block = new Element("dl.info")).adopt(new Element("dt[text=Commit]"), self.version_text = new Element("dd.version", {
            text: "Loading..."
        }), new Element("dt[text=Branch]"), self.branch_text = new Element("dd.branch"), new Element("dt[text=Updater]"), self.updater_type = new Element("dd.updater"), new Element("dt[text=PID]"), new Element("dd", {
