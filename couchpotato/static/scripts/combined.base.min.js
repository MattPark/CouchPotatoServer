...
var MetadataSettingTab = new Class({
    ...
    renderStats: function(json) {
        ...
        if (json.opensubtitles && self.stats_panels["opensubtitles"]) {
            ...
            self.stats_panels["opensubtitles"].set("html", '<div class="stats_grid">' + '<div class="stat_item"><span class="stat_value">' + os.searches_today + '</span><span class="stat_label">Searches Today</span></div>' + '<div class="stat_item"><span class="stat_value">' + os.hash_hits_today + '</span><span class="stat_label">Hash Hits</span></div>' + '<div class="stat_item"><span class="stat_value">' + (os.has_api_key ? "Configured" : "Not Set") + '</span><span class="stat_label">API Key</span></div>' + "</div>");
        }
    }
});
