                ...
                onComplete: function(json) {
                    if (!json || !json.progress) {
                        ...
                        if (json.results && json.results.scanning) {
                            new Element("span.scan_live_count", { text: " (" + json.results.movies_found + " found, " + json.results.movies_added + " added)" }).inject(status_line);
                        }
                        var sorted_table = self.parseProgress(json.progress);
                        sorted_table.each(function(folder) {
                            var folder_progress = progress[folder];
                            new Element("div.scan_folder_row").adopt(new Element("span.folder", {
