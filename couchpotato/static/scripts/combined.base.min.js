        ...
        list_el.addEvent("refreshDropdown", function() {
            ...
            fieldsets.each(function(fs) {
                if (fs.getStyle("display") === "none") {
                    var label = fs.getElement("h2 .group_label");
                    if (label) { dropdown.adopt(new Element("option", {"value": "enable:" + label.get("text").trim(), "text": label.get("text").trim()})); }
                }
            });
            ...
            if (enabled_fieldsets.length > 0) {
                ...
                enabled_fieldsets.each(function(fs) {
                    ...
                    if (base_type && !seen[base_type]) {
                        ...
                        optgroup.adopt(new Element("option", {"value": "duplicate:" + base_type, "text": display_name}));
                    }
                });
                if (optgroup.getElements("option").length > 0) { dropdown.adopt(optgroup); }
            }
